...
import { ArrowUpRight, ArrowDownLeft, Copy, Check, X, ShieldCheck, Globe, ChevronDown, Lock, Smartphone, Clock, AlertCircle, ExternalLink, Activity, Filter } from 'lucide-react';
            ...
            filteredTransactions.map(tx => {
                ...
                return (
                    ...
                    <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center border border-white/5 relative ${
                            isFailed 
                        ...
                        <div className={`absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-2 border-surface flex items-center justify-center ${
                            tx.status === 'Completed' ? 'bg-blue-500 text-black' :
                    ...
                    <div className={`font-mono font-bold text-sm ${
                        isFailed ? 'text-error' : (tx.type === 'Earning' ? 'text-success' : 'text-white')
                    }`}>
            ...
            <div className="relative w-full max-w-lg bg-[#111] border-t border-white/10 rounded-t-[2rem] p-6 pb-8 shadow-2xl animate-in slide-in-from-bottom duration-300">
               ...
               <div className="flex flex-col items-center mb-6">
                  <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-4 border border-white/10 ${
                     selectedTransaction.status === 'Failed' ? 'bg-error/10 text-error' :
